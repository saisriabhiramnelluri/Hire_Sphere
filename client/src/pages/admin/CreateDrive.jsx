...
import { BRANCHES, JOB_TYPES, WORK_MODES } from '../../utils/constants';
      ...
      <FadeIn>
        <div className="flex items-center space-x-4">
          ...
          <div>
            ...
            <p className="text-primary-600 mt-1">Add a new placement drive</p>
          </div>
        </div>
      </FadeIn>
        ...
        <FadeIn delay={0.5}>
          <Card title="Selection Process">
            <div className="space-y-4">
              ...
              <Button type="button" variant="secondary" onClick={addStage} icon={<IoAdd />}>
                Add Stage
              </Button>
            </div>
          </Card>
