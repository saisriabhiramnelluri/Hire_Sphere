...
import { IoArrowBack, IoAdd, IoClose, IoSave, IoWarning } from 'react-icons/io5';
...
const EditDrive = () => {
    ...
    const fetchDrive = async () => {
        try {
            ...
            if (response.success && response.data.drive) {
                ...
                setWasApproved(drive.isApproved);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (response.success) {
                if (wasApproved) {
                    toast.success('Drive updated! Re-approval required from admin.');
                } else {
            ...
            {wasApproved && (
                <FadeIn delay={0.05}>
                    <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 flex items-start space-x-3">
                        <IoWarning className="text-yellow-600 flex-shrink-0 mt-0.5" size={24} />
                        <div>
                            <p className="font-medium text-yellow-800">Re-approval Required</p>
                            <p className="text-sm text-yellow-700">
                                This drive was already approved. Any changes will require re-approval from the admin before the drive becomes visible to students again.
                            </p>
                        </div>
                    </div>
                </FadeIn>
