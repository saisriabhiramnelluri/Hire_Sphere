...
import { IoTrophy, IoDownload, IoAdd, IoEye } from 'react-icons/io5';
      ...
      <FadeIn>
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-primary-600 mt-1">Track and manage job offers</p>
          </div>
      ...
      <FadeIn delay={0.1}>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Card className="text-center bg-gradient-to-br from-yellow-50 to-yellow-100">
            <p className="text-sm text-yellow-700 font-medium mb-2">Pending Offers</p>
            <p className="text-4xl font-bold text-yellow-900">
              {offers.filter((o) => o.status === 'pending').length}
            </p>
          </Card>
          <Card className="text-center bg-gradient-to-br from-green-50 to-green-100">
            <p className="text-sm text-green-700 font-medium mb-2">Accepted Offers</p>
            <p className="text-4xl font-bold text-green-900">
              {offers.filter((o) => o.status === 'accepted').length}
            </p>
          </Card>
          <Card className="text-center bg-gradient-to-br from-red-50 to-red-100">
            <p className="text-sm text-red-700 font-medium mb-2">Rejected Offers</p>
        ...
        <Card>
          {loading ? (
            ...
            <div className="text-center py-12">
              ...
              <p className="text-primary-600">No offers made yet</p>
            </div>
          ) : (
            <>
      ...
      <Modal isOpen={isDetailsModalOpen} onClose={closeDetailsModal} title="Offer Details" size="lg">
        {selectedOffer && (
          <div className="space-y-6">
            ...
            {selectedOffer.studentRemarks && (
              <div>
                <h3 className="text-sm font-medium text-primary-600 mb-2">Student Remarks</h3>
                <p className="text-primary-700 text-sm bg-primary-50 p-3 rounded-lg">
                  {selectedOffer.studentRemarks}
                </p>
              </div>
            )}
